...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex(TABLE_ACCOUNTS).insert([
    { id: 1, username: "usuario1", email: "user1@mail.com", password: "$2b$10$REQi9d18Z38aSyVbV9AX7u3EzXNr7f4Xa4UmcdpNUyG3jOZXTvoKS", cellphone_num: "70000001" }, // user simple
    { id: 2, username: "adminuser", email: "adminuser@mail.com", password: "$2b$10$REQi9d18Z38aSyVbV9AX7u3EzXNr7f4Xa4UmcdpNUyG3jOZXTvoKS", cellphone_num: "70000002" }, // admin + user
    { id: 3, username: "adminsolo", email: "admin@mail.com", password: "$2b$10$REQi9d18Z38aSyVbV9AX7u3EzXNr7f4Xa4UmcdpNUyG3jOZXTvoKS", cellphone_num: "70000003" }, // admin puro
    { id: 4, username: "empresa1", email: "empresa@mail.com", password: "$2b$10$REQi9d18Z38aSyVbV9AX7u3EzXNr7f4Xa4UmcdpNUyG3jOZXTvoKS", cellphone_num: "70000004" }, // empresa
  ]);
